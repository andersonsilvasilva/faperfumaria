    ...
    const order = await prisma.$transaction(async (tx) => {
      ...
      const createdOrder = await tx.order.create({
        data: {
          ...
          shippingLabel,
          shippingZipCode: data.shippingMethod !== "LOCAL_PICKUP" ? data.cep : null,
          shippingStreet: data.shippingMethod !== "LOCAL_PICKUP" ? data.street : null,
          shippingNumber: data.shippingMethod !== "LOCAL_PICKUP" ? data.number : null,
          shippingComplement: data.shippingMethod !== "LOCAL_PICKUP" ? data.complement || null : null,
          shippingNeighborhood: data.shippingMethod !== "LOCAL_PICKUP" ? data.neighborhood : null,
          shippingCity: data.shippingMethod !== "LOCAL_PICKUP" ? data.city : null,
          shippingState: data.shippingMethod !== "LOCAL_PICKUP" ? data.state : null,
          subtotal,
