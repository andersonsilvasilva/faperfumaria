# CLAUDE.md — FA Perfumaria

Este arquivo é a especificação mestre do projeto **FA Perfumaria** para execução no Claude Code.

## Regra de uso

- Leia este arquivo integralmente antes de alterar o projeto.
- Execute primeiro a auditoria do repositório.
- Preserve código válido existente.
- Trabalhe por fases.
- Ao final de cada fase, valide lint, typecheck, testes e build.
- Não introduza complexidade desnecessária.
- Priorize vendas, segurança, experiência do cliente e operação da loja.
